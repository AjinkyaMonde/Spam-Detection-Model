...
st.write("Write your SMS/Email to detect it")
dataset = st.sidebar.selectbox("Select dataset", ("SMS", "Email"))
st.write(dataset)

algorithm = st.sidebar.selectbox("Select Naive Bayes Algorithm",("GaussianNB","MultinomialNB", "BernoulliNB" ))
